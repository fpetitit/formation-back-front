...
- **Courbe d'apprentissage**: Moyenne (concepts enterprise)
...
<div style="display: flex; flex-direction: column; gap: 20px; align-items: center; max-width: 100%">
  <img src="https://logos-marques.com/wp-content/uploads/2021/03/Java-Logo.png" alt="Logo Java" style="height: 100px;" />
  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/Spring_Framework_Logo_2018.svg/1280px-Spring_Framework_Logo_2018.svg.png" alt="Logo Spring Framework" style="height: 60px;" />
</div>
</div>
...
<div style="display: flex; flex-direction: column; gap: 20px; align-items: center;">
  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d9/Node.js_logo.svg/1280px-Node.js_logo.svg.png" alt="Logo Node.js" style="height: 100px;" />
  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTbaFE1Vzg5PH7mKv6NmVEmXMzSThQe-FLbmw&s" alt="Logo NestJS" style="height: 100px;" />
</div>
</div>
...
<div style="display: flex; flex-direction: column; gap: 20px; align-items: center;">
  <img src="https://upload.wikimedia.org/wikipedia/commons/f/f8/Python_logo_and_wordmark.svg" alt="Logo Python" style="height: 100px;" />
  <img src="https://www.djangoproject.com/m/img/logos/django-logo-negative.png" alt="Logo Django" style="height: 100px;" />
  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRA4OKx8IMFA3NH3DDwdbVfS-mP9BboGcRD3g&s" alt="Logo FastAPI" style="height: 80px;" />
</div>
</div>
...
<div style="display: flex; flex-direction: column; gap: 20px; align-items: center;">
  <img src="https://upload.wikimedia.org/wikipedia/fr/9/99/Logo_microsoft_net.png" alt="Logo .NET" style="height: 100px;" />
</div>
</div>
